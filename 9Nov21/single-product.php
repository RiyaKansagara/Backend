				...
				?>
                    ...
                    <div class="col-md-5">
                        <div class="single-product-img">
                            <img src=<?php echo htmlentities($row['image']); ?> alt="" height="400" width="350">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="single-product-content">
                            <h3><?php echo htmlentities($row['pname']); ?></h3>
                            <p class="single-product-pricing"><span>Per Kg</span> $<?php echo htmlentities($row['price']); ?></p>
                            ...
                            <div class="single-product-form">
                                ...
                                <p><strong>Categories: </strong><?php echo htmlentities($row['category']); ?></p>
                            </div>
                            <h4>Share:</h4>
    ...
    <div class="more-products mb-150">
        <div class="container">
            ...
            <div class="row">
                <?php
                include "con.php";
                $query=mysqli_query($con,"select * from Product limit 3");
                while($row=mysqli_fetch_array($query))
                {?>
